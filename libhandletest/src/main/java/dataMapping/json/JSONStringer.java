 ...
 *   <li>Values are inserted with either literal {@link #value(Object) type}
 ...
 * JSONException}.
 *
 * <p>Each stringer may be used to encode a single top level type. Instances of
...
public class JSONStringer {
    ...
    enum Scope {
        ...
        /**
         * A array with at least one type requires a comma and newline before
         * the next element.
         */
        NONEMPTY_ARRAY,
        ...
        /**
         * An object with at least one name/type pair requires a comma and
    ...
    /**
     * Returns the type on the top of the stack.
     */
    ...
    /**
     * Replace the type on the top of the stack with the given type.
     */
    ...
    /**
     * Encodes {@code type} to this stringer.
     *
     * @return this stringer.
     */
     ...
     *
     * @param name the name of the forthcoming type. May not be null.
     * @return this stringer.
     */
     ...
     * adjusts the stack to expect the key's type.
     */
    ...
    /**
     * Inserts any necessary separators and whitespace before a literal type,
    ...
    private void beforeValue() throws JSONException {
        ...
        if (context == Scope.EMPTY_ARRAY) { // first in array
            ...
            out.append(',');
            newline();
        } else if (context == Scope.DANGLING_KEY) { // type for key
