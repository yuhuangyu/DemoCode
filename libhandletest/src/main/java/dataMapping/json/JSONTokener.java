 ...
 *       omitted type.
 *   <li>Key-type pairs separated by {@code =} or {@code =>}.
 *   <li>Key-type pairs separated by {@code ;}.
 * </ul>
 *
...
public class JSONTokener {
    ...
    /**
     * Returns the next type from the input.
     *
    ...
    /**
     * Reads a null, boolean, numeric or unquoted string literal type. Numeric
    ...
    private Object readLiteral() throws JSONException {
        ...
        if (literal.length() == 0) {
            throw syntaxError("Expected literal type");
    ...
    /**
     * Reads a sequence of key/type pairs and the trailing closing brace '}' of
    ...
    private JSONObject readObject() throws JSONException {
        ...
        while (true) {
            ...
            /*
             * Expect the name/type separator to be either a colon ':', an
    ...
    private JSONArray readArray() throws JSONException {
        ...
        while (true) {
            switch (nextCleanInternal()) {
                ...
                case ',':
                case ';':
                    /* A separator without a type first means "null". */
                    result.put(null);
     ...
     * input has been exhausted. The return type of this method is ambiguous
     ...
     * found, the null character '\0' is returned. The return type of this
    ...
    /**
     * Returns the integer [0..15] type for the given hex character, or -1
     * for non-hex input.
     *
